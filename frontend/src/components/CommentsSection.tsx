  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-bold lg:text-base">Comments</h3>
      ...
      {isSignedIn ? (
        <form onSubmit={handleSubmit} className="flex gap-2">
          <input
            ...
            className="input input-bordered input-sm flex-1 bg-base-200 lg:text-base lg:py-4"
            value={content}
          ...
          >
            {createComment.isPending ? (
              ...
              <SendIcon className="size-4 lg:size-5" />
            )}
          </button>
        </form>
      ) : (
      ...
      <div className="space-y-2 max-h-80 overflow-y-auto">
        {comments.length === 0 ? (
          <div className="text-center py-8 text-base-content/50 flex flex-col gap-2">
